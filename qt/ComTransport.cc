...
public:
    ...
    {
        return call_reply("AddMetainfo(QString)", Utils::qstringFromUtf8(metainfo));
    }
...
public:
    explicit Impl(QString const& config_dir)
        : moniker_item_{ Utils::qstringFromUtf8(tr::interop::com_config_moniker_item(config_dir.toStdString())) }
